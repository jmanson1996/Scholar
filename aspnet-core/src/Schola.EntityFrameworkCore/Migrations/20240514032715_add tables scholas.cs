...
{
    /// <inheritdoc />
    public partial class addtablesscholas : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserTeacherId = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Asignation_Course",
                        column: x => x.CourseId,
                        principalTable: "Course",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Asignation_User",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assistance_Course",
                        column: x => x.CourseId,
                        principalTable: "Course",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Assistance_User",
                        column: x => x.UserStudentId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Asignation_CourseId",
                table: "Asignation",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Asignation_UserStudentId",
                table: "Asignation",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assistance_UserStudentId",
                table: "Assistance",
                column: "UserStudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comment_UserCommentId",
                table: "Comment",
                column: "UserCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_Course_UserTeacherId",
                table: "Course",
