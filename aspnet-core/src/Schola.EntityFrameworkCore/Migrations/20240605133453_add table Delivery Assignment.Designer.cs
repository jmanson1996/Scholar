...
namespace Schola.Migrations
{
    ...
    [Migration("20240605133453_add table Delivery Assignment")]
    partial class addtableDeliveryAssignment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Schola.Asignations.Asignation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Asignation");
                });

            modelBuilder.Entity("Schola.Assistances.Assistance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Schola.Comments.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Schola.Courses.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Schola.DeliveryAssignments.DeliveryAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Schola.Materiales.Material", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Schola.UserCourses.UserCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Schola.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Schola.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Schola.Asignations.Asignation", b =>
                {
                    b.HasOne("Schola.Courses.Course", "Course")
                        .WithMany("Asignation")
                    ...
                    b.HasOne("Schola.Authorization.Users.User", "User")
                        .WithMany("Asignation")
            ...
            modelBuilder.Entity("Schola.DeliveryAssignments.DeliveryAssignment", b =>
                {
                    b.HasOne("Schola.Asignations.Asignation", "Asignation")
                        .WithMany("DeliveryAssignment")
                        .HasForeignKey("AsignationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("FK_DeliveryAssignment_Asignation");

                    b.HasOne("Schola.Authorization.Users.User", "UserStudent")
                        .WithMany("DeliveryAssignment")
                        .HasForeignKey("UserStudentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
            ...
            modelBuilder.Entity("Schola.UserCourses.UserCourse", b =>
                {
                    b.HasOne("Schola.Courses.Course", "Curso")
                        .WithMany("UserCourse")
