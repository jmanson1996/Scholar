...
{
    public abstract class ScholaWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ScholaWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ScholaWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ScholaDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ScholaDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ScholaDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ScholaDbContext, Task<T>> func)
        {
            T result;
